...
device. The current app does not send them to Wasting No Time or other
companies. It has no ads, analytics, or sync service.
...
If the app later adds sync, analytics, or other data processing, this policy
