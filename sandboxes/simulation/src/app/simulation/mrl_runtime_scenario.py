...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_edges=[
            ObservatoryEdge("Planner", "create_task", "intends"),
            ObservatoryEdge("Planner", "open_day", "intends"),
            ObservatoryEdge("User", "touch_card", "intends"),
            ObservatoryEdge("User", "complete_card", "intends"),
            ObservatoryEdge("User", "dismiss_card", "intends"),
            ObservatoryEdge("User", "reorder_card", "intends"),
            ObservatoryEdge("User", "jump_to_card", "intends"),
            ObservatoryEdge("DayBoundary", "open_day", "intends"),
            ObservatoryEdge("DayBoundary", "close_day", "intends"),
            ObservatoryEdge("Analyst", "get_analytics", "intends"),
